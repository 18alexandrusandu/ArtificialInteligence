...
def choce_random_game_version(ver=None):
 ...
 if ver==None:
   ...
   paths=[file_dir_path+g_dir+"/bombs"+version,file_dir_path+g_dir+"/messages"+version,file_dir_path+g_dir+"/key_door"+version]
 else:
   paths=[file_dir_path+g_dir+"/bombs"+ver,file_dir_path+g_dir+"/messages"+ver,file_dir_path+g_dir+"/key_door"+ver]
